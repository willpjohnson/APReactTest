...
var createSubscription = exports.createSubscription = function createSubscription(email) {
  return $.ajax({
    method: 'POST',
...
var createSession = exports.createSession = function createSession(data) {
  return $.ajax({
    method: "POST",
...
var _landing_page = __webpack_require__(79);

var _landing_page2 = _interopRequireDefault(_landing_page);

var _authentication = __webpack_require__(84);
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/authentication', component: _authentication2.default })
  );
};
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            { id: 'navbar-reactor', className: 'navbar-link' },
            'Reactor'
          )
        ),
        _react2.default.createElement(
          _reactRouterDom.Link,
          { style: { textDecoration: "none" }, to: '/authentication' },
          _react2.default.createElement(
            'h1',
            { id: 'navbar-login', className: 'navbar-link' },
            'Log In'
          )
        )
      );
...
var _summary = __webpack_require__(81);

var _summary2 = _interopRequireDefault(_summary);

var _subscribe = __webpack_require__(82);
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { id: "banner" },
        _react2.default.createElement("img", { id: "banner-image", src: "assets/banner.png" }),
        _react2.default.createElement(
          "h1",
          { style: { top: this.state.top + "px", left: this.state.left + "px" }, id: "banner-text" },
...
var Summary = function Summary() {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { id: "summary-2-content" },
        _react2.default.createElement(
          "div",
          { className: "summary-2-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/1.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-2-text" },
            _react2.default.createElement(
              "span",
              { className: "summary-title" },
        ...
        _react2.default.createElement(
          "div",
          { className: "summary-2-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/2.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-2-text" },
            _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { id: "summary-3-content" },
        _react2.default.createElement(
          "div",
          { className: "summary-3-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/3.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-3-unit-header" },
            "East Josianefurt"
          ),
          _react2.default.createElement(
            "p",
            { className: "summary-3-unit-address" },
            "085 Daron Via"
          )
        ),
        _react2.default.createElement(
          "div",
          { className: "summary-3-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/4.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-3-unit-header" },
        ...
        _react2.default.createElement(
          "div",
          { className: "summary-3-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/5.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-3-unit-header" },
            "Concepcionbury"
        ...
        _react2.default.createElement(
          "div",
          { className: "summary-3-unit" },
          _react2.default.createElement("img", { className: "summary-image", src: "assets/6.png" }),
          _react2.default.createElement(
            "p",
            { className: "summary-3-unit-header" },
            "Reychester"
...
var _api_util = __webpack_require__(35);
...
var Subscribe = function (_React$Component) {
  ...
  _createClass(Subscribe, [{
    ...
    value: function update() {
      ...
      return function (e) {
        _this2.setState({ email: e.currentTarget.value });
      };
    }
  }, {
    key: 'submit',
    value: function submit() {
      (0, _api_util.createSubscription)(this.state.email);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'subscribe-form' },
          _react2.default.createElement('input', { onChange: this.update(), id: 'subscribe-input', type: 'text', placeholder: 'Your Email' }),
          _react2.default.createElement(
            'div',
            { onClick: this.submit, id: 'subscribe-button' },
            _react2.default.createElement(
              'h4',
...
var _auth_form = __webpack_require__(85);
...
var Authentication = function Authentication() {
  return _react2.default.createElement(
    'div',
    { id: 'auth' },
    _react2.default.createElement(_auth_form2.default, null)
  );
};
...
var AuthForm = function (_React$Component) {
  ...
  _createClass(AuthForm, [{
    ...
    value: function login() {
      ...
      (0, _api_util.createSession)(data);
    }
  }, {
    key: 'signup',
    value: function signup() {
      var data = { username: this.state.username, email: this.state.email, password: this.state.password };
      var loginData = { email: this.state.email, password: this.state.password };
      (0, _api_util.createUser)(data).then(function () {
        return (0, _api_util.createSession)(loginData);
      });
    }
  }, {
    key: 'makeSelection',
    value: function makeSelection(e) {
    ...
    key: 'render',
    value: function render() {
      var signupClass = this.state.type === "signup" ? "selected" : "";
      var loginClass = this.state.type === "login" ? "selected" : "";
      var usernameSection = this.state.type === "login" ? null : _react2.default.createElement(
        'div',
        { className: 'auth-form-field' },
        _react2.default.createElement('div', { className: 'auth-form-field-blue' }),
        _react2.default.createElement('img', { className: 'auth-form-icon', src: 'assets/ic-username.png' }),
        _react2.default.createElement('input', { onChange: this.update("username"), className: 'auth-form-input', type: 'text', placeholder: 'Username', value: this.state.username })
      );
      var buttonText = this.state.type === "login" ? "LOGIN" : "SIGN UP";
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'auth-form-selector' },
          _react2.default.createElement(
            'div',
            { style: { width: "200px" } },
            _react2.default.createElement(
              'h2',
              { onClick: this.makeSelection, className: 'auth-form-selection ' + signupClass },
              'SIGN UP'
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h2',
              { onClick: this.makeSelection, className: 'auth-form-selection ' + loginClass },
              'LOGIN'
            )
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'auth-form-field' },
            _react2.default.createElement('div', { className: 'auth-form-field-blue' }),
            _react2.default.createElement('img', { className: 'auth-form-icon', src: 'assets/ic-email.png' }),
            _react2.default.createElement('input', { onChange: this.update("email"), className: 'auth-form-input', type: 'text', placeholder: 'Email', value: this.state.email })
          ),
          _react2.default.createElement(
            'div',
            { className: 'auth-form-field' },
            _react2.default.createElement('div', { className: 'auth-form-field-blue' }),
            _react2.default.createElement('img', { className: 'auth-form-icon', src: 'assets/ic-password.png' }),
            _react2.default.createElement('input', { onChange: this.update("password"), className: 'auth-form-input', type: 'password', placeholder: 'Password', value: this.state.password })
          )
        ),
        _react2.default.createElement(
          'div',
          { onClick: this.submit, id: 'auth-form-button' },
          buttonText
        )
      );
    }
